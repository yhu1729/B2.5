...
MODLISTF += ${SRCDIR}/*/b2mod_*.F ${SRCDIR}/*/b2us_*.F ${SRCDIR}/*/b2us_*.F90
...
EX90LIST = ${patsubst %.exe, %.o, ${PROG_TEST} ${PROG_90} ${PROG_ID}}
ADEXTRA =
ifdef DIFF_D
...
DEFAULT: VERSION AM_FILES ${TESTEXE} ${MNEXE} ${AMEXE} ${OEEXE} ${COEXE} ${OTEXE} ${O9EXE}
ALL: VERSION AM_FILES ${TESTEXE} ${MNEXE} ${AMEXE} ${OEEXE} ${COEXE} ${OTEXE} ${O9EXE} ${XDEXE}
NOPLOT: VERSION AM_FILES ${TESTEXE} ${MNEXE} ${AMEXE} ${OEEXE} ${COEXE} ${OTEXE} ${O9EXE}
